package com.example.flashlightmobile;
...
//            Toast.makeText(MainActivity.this, "FlashLight is OFF", Toast.LENGTH_SHORT).show();
    ...
    protected void onPause() {
        ...
        // Check if the flashlight is on and turn it off if needed
        if (flashOn) {
            flashLightOff();
            flashOn = false;
            toggleButton.setImageResource(R.drawable.power_off);
...
//        super.onResume();
//
//        // Check if the flashlight was on before, and turn it on if needed
//        if (flashOn) {
//            flashLightOn();
//        }
//    }
